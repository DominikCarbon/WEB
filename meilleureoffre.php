...
<div id="items">
<div class="container">  
    <center><h1>Meilleure offre</h1><input type="text" placeholder="rechercher un item.." name="search"/>&nbsp;<span class="glyphicon glyphicon-search"></span></center>
...
<div class="container" id="item">
	...
	<div class="row" id="rang1">
        ...
        <div class="col-sm-2"><b>Catégorie</b></div>
