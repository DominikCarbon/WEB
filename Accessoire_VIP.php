...
<div class="container" id="item">
	<div class="row">
		...
		<div class="col-sm-2" align="center"><b>Ajouter au panier</b></div>
	</div>
	...
	<div class="row" id="rang1">
		...
		<div class="col-sm-2" align="center"><p ><?php echo '<a href="supprimer.php?id='.$_SESSION['id'].'"><span class="glyphicon glyphicon-basket" id="trash"></span></a>';?>
        </p></div>
