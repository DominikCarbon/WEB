...
<div class="container">  
    <center><h1>Tout les Articles</h1><input type="text" placeholder="rechercher un item.." name="search"/>&nbsp;<span class="glyphicon glyphicon-search"></span></center>
  <div class="row">
      ...
      <div class="panel panel-danger">
        ...
        <br/>&nbsp;&nbsp;<b>Etat</b> :<br/>Neuf<h1 align="right"><?php echo '<a href="itemadminsupr.php?id='.$_SESSION['id'].'"><span class="glyphicon glyphicon-trash" id="trash"></span></a>';?></h1></div>
      </div>
      <?php endforeach ?>
